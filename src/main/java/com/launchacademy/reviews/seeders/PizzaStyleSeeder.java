...
public class PizzaStyleSeeder {
  ...
  public void run(){
    ...
    pizzaStyle.setImgUrl("https://cdnimg.webstaurantstore.com/uploads/buying_guide/2014/11/pizzatypes-deepdish.jpg");
    service.save(pizzaStyle);
    pizzaStyle = new PizzaStyle();
    pizzaStyle.setName("Neapolitan");
    pizzaStyle.setImgUrl("https://cdnimg.webstaurantstore.com/uploads/buying_guide/2014/11/pizzatypes-margherita-.jpg");
    service.save(pizzaStyle);
    pizzaStyle = new PizzaStyle();
